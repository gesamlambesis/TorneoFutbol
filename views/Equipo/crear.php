...
include 'TorneoFutbol/libs/validaciones.php';

$obj = new validar;

//Guarda los valores de los campos en variables, siempre y cuando se haya enviado el formulario, sino se guardará null.
$nombre = isset($_POST['nombre_equipo']) ? $_POST['nombre_equipo'] : null;
$edad = isset($_POST['patrocinadores']) ? $_POST['patrocinadores'] : null;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   if (!$obj->validaRequerido($nombre)) {
      $errores[] = 'El campo nombre es incorrecto.';
    
     // echo "El campo nombre es incorrecto";
     // echo "<br>";
   }
   ...
   if (!$obj->validarEntero($edad, $opciones_edad)) {
      $errores[] = 'El campo edad es incorrecto.';
     
     // echo "El campo edad es incorrecto";
      // echo "<br>";
   }
   //Valida que el campo email sea correcto.
   if (!$obj->validaEmail($email)) {
      $errores[] = 'El campo email es incorrecto. ';
     
      //echo "El campo email es incorrecto";
      // echo "<br>";
   }
