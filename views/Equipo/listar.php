...
<h3 class="text-center"> Lista de Equipos</h3>
 <hr>
  ...
  <div class="row">
    ...
    <?php $datos = $this->getDatos(); foreach ($datos as $key => $equipo):?>
                 <tr>
                 <td><?php echo $equipo->nombre_equipo;?></td>
                 <td><?php echo $equipo->patrocinador;?></td>
                 <td><?php echo $equipo->categoria;?></td>
                 <td><?php echo $equipo->color_camiseta1;?></td>
                 <td><?php echo $equipo->color_camiseta2;?></td>
                 <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs prueba" value="<?php echo $equipo->id_equipo;?>" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></td>
                <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs prueba1" value="<?php echo $equipo->id_equipo;?>" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
                </tr>
                <?php endforeach; ?>
 ...
 <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <script type="text/javascript">
                ...
                $(".prueba").on("click", function(){                
                  $("#modal-edit").load("<?php echo URL_BASE;?>/index.php/Equipo/modificar_equipo", {identificador:$(this).val()});                               
                });
                </script>
